...
<form action="/admin/planos/salvar" method="post">
    ...
    <input type="text" id="titulo" name="titulo" required placeholder="Ex: TecFit Premium">
    ...
    <textarea id="beneficios" name="beneficios" required placeholder="Liste os benefícios do plano (um por linha):
- Acesso livre
- Avaliação física
