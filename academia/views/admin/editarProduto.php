...
<form action="/admin/produtos/salvar" method="post">
    ...
    <input type="url" id="imagem" name="imagem" value="<?= htmlspecialchars($produto['imagem']) ?>">
    
    <?php if ($produto['imagem']): ?>
        <img src="<?= htmlspecialchars($produto['imagem']) ?>" alt="Preview" class="preview-img">
    <?php endif; ?>

    <label for="estoque">Quantidade em Estoque:</label>
    <input type="number" id="estoque" name="estoque" value="<?= $produto['estoque'] ?? 0 ?>" min="0">
